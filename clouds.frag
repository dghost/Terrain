...
void main(void)
{
    // scale the textures to get more interesting results
    float xCoord = (TexCoord0.x + in_Offsets.x) * 4.0;
    float yCoord = (TexCoord0.y + in_Offsets.y) * 4.0;
    float time = in_Time / 5.0;
